	...
	<div id="main">
		...
		$sql = "select * 
				from havarisana_vozila.autodelovi as a
					join havarisana_vozila.felne_i_gume as b
				    on a.id_dela = b.id_dela";
		$result = mysqli_query($conn, $sql);
		if($result){
		?>
			<h3>U ponudi imamo sledeće modele felni i guma:</h3>
		<?php	
			...
			?>
				<div class="delovi">
					...
					<p><?php echo $naziv.$br, $cena."RSD".$br, $stanje.$br, $precnik.$br, $materijal.$br, $proizvodjac.$br; ?></p>
					<?php 
						if(isset($_SESSION["email"])){
					?>
		...
		?>
			<h3>Trenutno nemamo felne i gume u ponudi. Hvala.</h3>
		<?php
		}
		?>
	</div>
	...
	<div id="sidebar">
		...
		<nav id="parts">
			<ul>
				...
				<li><a href="delovi_motora"> Delovi motora</a></li>
				<li><a href="enterijer.php"> Enterijer</a></li>
				<li><a href=""> Felne i gume</a></li>
			</ul>
		</nav>
	</div>
